...
/**
 * Feign Client to fetch loan details from Loans service
 * @Author Maulik Davra
 * @since 1.0
 *
 * <p>
 * Behind the scenes,
 * my loans FeignClient will connect with the Eureka Server
 * and try to fetch all the instances that are registered with the logical name loans.
 * <p>
...
public interface LoansFeignClient {
    ...
    /**
     * Fetch loan details from Loans service
