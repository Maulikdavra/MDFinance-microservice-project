...
public class CustomerMapper {
    ...
    public static CustomerDto mapToCustomerDto(Customer customer, CustomerDto customerDto) {
        if(customer == null) {
            throw new NullPointerException("Customer object is null, please check the data.");
        }
    ...
    public static Customer mapToCustomer(CustomerDto customerDto, Customer customer) {
        if(customerDto == null) {
            throw new NullPointerException("CustomerDto object is null, please check the data.");
        }
