...
//                    ),
    ...
    public ResponseEntity<String> getJavaVersionFallback(Exception e) {
        logger.info("Executing JavaVersionFallback method");
        return ResponseEntity
    ...
    public ResponseEntity<AccountsContactInfoDto> getContactInfo() {
        logger.info("Trying to fetch contact info");
     ...
     */
    public ResponseEntity<AccountsContactInfoDto> getContactInfoFallback(Exception e) {
        logger.info("Executing ContactInfoFallback method");
        Map<String, String> contactDetails = Map.of("name", "Maulik Davra - Developer",
                "email", "maulik.davra@mdfinance.com");
        ...
        AccountsContactInfoDto fallbackContactInfo = new AccountsContactInfoDto(
                "Fallback message: Unable to fetch contact info at the moment",
                contactDetails,
                onCallSupport
        );
